...
const Leavehistory = () => {
    ...
    const Getyourleaveshistory = async () => {
        try {
            const url = `http://hrportal.dreambytesolution.com/employee/leavehistory/${employeeId}`;
            const headers = {
    ...
    const columns = [
        ...
        { field: 'startDate', headerName: 'Start Date', width: 150, renderCell: (params) => new Date(params.value).toLocaleDateString() },
        { field: 'endDate', headerName: 'End Date', width: 150, renderCell: (params) => new Date(params.value).toLocaleDateString() },
