        ...
        {role === "admin" && (
          <>
            <li className="nav-item">
             ...
             <li className='nav-item'>
                            <div className='nav-link' onClick={() => toggleDropdown('categorys')}>
                                ...
                                <ul className='nav-content'>
                                    <li className='ps-3'>
                                        <Link to='/add-employee' className='nav-link'>
                                            ...
                                            <span className='nav-heading collapsed'>Add Employee</span>
                                        </Link>
                                    </li>
                                    <li className='ps-3'>
                                        <Link to='/employee-list' className='nav-link'>
                                            <i className='bi bi-circle'></i>
                                            <span className='nav-heading collapsed'>Employee list</span>
                                        </Link>
                                    </li>
                                </ul>
                            )}
...
{/*
                        <li className='nav-item'>
                            <div className='nav-link' onClick={() => toggleDropdown('product')}>
                                <MdOutlineProductionQuantityLimits size={20} />
                                <span className='nav-heading collapsed'>Product</span>
                            </div>
                            {dropdowns.product && (
                                <ul className='nav-content'>
                                    <li className='ps-3'>
                                        <Link to='/add-product' className='nav-link'>
                                            <i className='bi bi-circle'></i>
                                            <span className='nav-heading collapsed'>Add Product</span>
                                        </Link>
                                    </li>
                                    <li className='ps-3'>
                                        <Link to='/product-list' className='nav-link'>
                                            <i className='bi bi-circle'></i>
                                            <span className='nav-heading collapsed'>Product list</span>
                                        </Link>
                                    </li>
                                </ul>
                            )}
...
*/}
        ...
        {role === "employee" && (
          <>
                                ...
                                <ul className='nav-content'>
                                    ...
                                    <li className='ps-3'>
                                        <Link to='/leave-history' className='nav-link'>
                                            <i className='bi bi-circle'></i>
                                            <span className='nav-heading collapsed'>Leave history</span>
                                        </Link>
                                    </li>
            ...
            {/*            <li className='nav-item'>
                            <div className='nav-link' onClick={() => toggleDropdown('proposals')}>
                                <RiBriefcase4Fill size={20} />
                                <span className='nav-heading collapsed'>User Billing</span>
                            </div>
                            {dropdowns.proposals && (
                                <ul className='nav-content'>
                                    <li className='ps-3'>
                                        <Link to='/addcus' className='nav-link'>
                                            <i className='bi bi-circle'></i>
                                            <span className='nav-heading collapsed'>Add Customers</span>
                                        </Link>
                                    </li>
                                    <li className='ps-3'>
                                        <Link to='/customer-list' className='nav-link'>
                                            <i className='bi bi-circle'></i>
                                            <span className='nav-heading collapsed'>Customer List</span>
                                        </Link>
                                    </li>
                                    <li className='ps-3'>
                                        <Link to='/your-products' className='nav-link'>
                                            <i className='bi bi-circle'></i>
                                            <span className='nav-heading collapsed'>Buy Now</span>
                                        </Link>
                                    </li>
                                    <li className='ps-3'>
                                        <Link to='/customer-orders' className='nav-link'>
                                            <i className='bi bi-circle'></i>
                                            <span className='nav-heading collapsed'>View Assign</span>
                                        </Link>
                                    </li>
                                </ul>
                            )}
